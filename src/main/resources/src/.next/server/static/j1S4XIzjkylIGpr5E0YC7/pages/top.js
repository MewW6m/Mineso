...
class common_head_CommonHead extends external_react_default.a.Component {
  render() {
    return __jsx("div", null, __jsx(next_document["Head"], null, __jsx("meta", {
      charSet: "UTF-8"
    }), __jsx("meta", {
      name: "viewport",
...
class top_TopPage extends external_react_default.a.Component {
  render() {
    return top_jsx("div", null, top_jsx(common_head, null), top_jsx(next_document["Head"], null, top_jsx("title", null, "MinesO - \u5229\u7528\u30B5\u30FC\u30D3\u30B9\u4E00\u89A7\u7BA1\u7406"), top_jsx("link", {
      rel: "stylesheet",
      type: "text/css",
